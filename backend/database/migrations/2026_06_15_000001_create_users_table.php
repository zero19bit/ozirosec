...
return new class extends Migration
{
    ...
    {
        // This migration was historically misnamed and may have run against
        // databases where these columns already existed. Do not drop columns
        // here because ownership cannot be determined safely.
    }
};
