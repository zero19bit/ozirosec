...
final class ApiV1RouteContractTest extends TestCase
{
    ...
    public function test_complete_v1_route_contract_remains_available(): void
    {
        ...
        $expected = collect([
            ...
            ['methods' => ['GET'], 'uri' => 'api/v1/admin/writeups/{writeup}', 'name' => 'api.v1.admin.'],
            ['methods' => ['PATCH'], 'uri' => 'api/v1/admin/writeups/{writeup}', 'name' => 'api.v1.admin.'],
            ['methods' => ['DELETE'], 'uri' => 'api/v1/admin/writeups/{writeup}', 'name' => 'api.v1.admin.'],
            ['methods' => ['GET'], 'uri' => 'api/v1/admin/writeups', 'name' => 'api.v1.admin.'],
            ['methods' => ['POST'], 'uri' => 'api/v1/admin/writeups', 'name' => 'api.v1.admin.'],
